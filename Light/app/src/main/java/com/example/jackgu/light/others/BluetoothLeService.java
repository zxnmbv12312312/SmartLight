...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED ="com.example.jackgu.light.others.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.example.jackgu.light.others.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.example.jackgu.light.others.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_READ = "com.example.jackgu.light.others.ACTION_DATA_READ";
    public final static String ACTION_DATA_NOTIFY = "com.example.jackgu.light.others.ACTION_DATA_NOTIFY";
    public final static String ACTION_DATA_WRITE = "com.example.jackgu.light.others.ACTION_DATA_WRITE";
    public final static String EXTRA_DATA = "com.example.jackgu.light.others.EXTRA_DATA";
    public final static String EXTRA_UUID = "com.example.jackgu.light.others.EXTRA_UUID";
    public final static String EXTRA_STATUS = "com.example.jackgu.light.others.EXTRA_STATUS";
    public final static String EXTRA_ADDRESS = "com.example.jackgu.light.others.EXTRA_ADDRESS";
