...
public class MaterialColor {
    ...
    private static TreeMap<String, Integer> sMaterialHashMap;
    private static Pattern sColorPattern = Pattern.compile("_[aA]?+\\d+");

    private static TreeMap<String, Integer> getMaterialColors(Context context) {
        Field[] fields = R.color.class.getFields();
        TreeMap<String, Integer> materialHashMap = new TreeMap<String, Integer>(String.CASE_INSENSITIVE_ORDER);
    ...
    public static Map.Entry<String, Integer> getColor(Context context, String regex, int index) {
        if (sMaterialHashMap == null) {
            sMaterialHashMap = getMaterialColors(context);
        }
    ...
    public static List<Map.Entry<String, Integer>> getAllColor(Context context, String regex){
        if (sMaterialHashMap == null) {
            sMaterialHashMap = getMaterialColors(context);
        }
