...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
    ...
    private static final int COLOR_UNSELECT = Color.argb(100, 0x00, 0x00, 0x00);
    ...
    private void init() {
        ...
        mIndicators[1] = createIndicator(R.drawable.ic_favorites,
                R.string.tab_favorites, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
        mIndicators[1].setBackgroundColor(Color.alpha(0));
        mIndicators[1].setTag(Integer.valueOf(1));
        mIndicators[1].setOnClickListener(this);
        addView(mIndicators[1]);
        mIndicators[2] = createIndicator(R.drawable.ic_settings,
        ...
        mIndicators[3] = createIndicator(R.drawable.ic_info,
                R.string.tab_info, COLOR_UNSELECT, TAG_ICON_3, TAG_TEXT_3);
    ...
    public static void setIndicator(int which) {
        ...
        if (mCurIndicator < 4) {
            ...
            switch (mCurIndicator) {
                ...
                case 1:
                    ...
                    prevIcon.setImageResource(R.drawable.ic_favorites);
                ...
                case 2:
                    ...
                    prevIcon.setImageResource(R.drawable.ic_settings);
                ...
                case 3:
                    ...
                    prevIcon.setImageResource(R.drawable.ic_info);
        ...
        switch (which) {
            ...
            case 1:
                ...
                currIcon.setImageResource(R.drawable.ic_favorites_focused);
            ...
            case 3:
                ...
                currIcon.setImageResource(R.drawable.ic_info_focused);
